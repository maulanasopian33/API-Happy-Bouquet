...
const { authenticateToken, authorizeRoles, requireActiveReseller } = require('../middlewares/authMiddleware');
const { createUploader } = require('../middlewares/uploadMiddleware');
const authCtrl = require('../controllers/resellerAuthController');
const catalogCtrl = require('../controllers/resellerCatalogController');
const clientCtrl = require('../controllers/resellerClientController');
const orderCtrl = require('../controllers/resellerOrderController');
const earningCtrl = require('../controllers/resellerEarningController');
const adminCtrl = require('../controllers/resellerAdminController');
